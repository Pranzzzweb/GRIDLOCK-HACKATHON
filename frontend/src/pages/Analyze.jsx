    ...
    try {
      ...
      setTimeout(() => {
        setResult({
              ...
              motorcyclist_count: 2,
              helmet_count: 1,
              plate_text: "DL 4C AB 1234",
              ocr_confidence: 0.92,
            ...
            <div className="results-grid mt-3">
              ...
              <div className="result-details">
                <div className="detail-item">
                  ...
                  <span className="value">{result.motorcyclist_count || 0}</span>
                </div>
                <div className="detail-item">
                  <span className="label">Helmets Detected</span>
                  <span className="value">{result.helmet_count || 0}</span>
                </div>
                <div className="detail-item">
                  <span className="label">License Plate (OCR)</span>
                  <span className="value highlight">{result.plate_text || 'Not Detected'}</span>
                </div>
                ...
                <div className="stats-row">
                  <div className="stat-sm">
                    ...
                    <strong>{((result.ocr_confidence || 0) * 100).toFixed(1)}%</strong>
                  </div>
                  <div className="stat-sm">
                    <span>Inference</span>
                    <strong>N/A</strong>
                ...
                <div className="download-actions mt-3">
                  <a
                      href={
                       result.challan_path
                      ? `http://localhost:5000${result.challan_path}`
                      : "#"
                      }
                      target="_blank"
